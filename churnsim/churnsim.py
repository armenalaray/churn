...
from churnsim.behavior import LogNormalBehaviorModel
from churnsim.churndb import drop_schema, setup_churn_db
from churnsim.churncloud import (
    convert_csvs_to_parquet,
    upload_files_to_cloud_storage,
    download_cloud_file_if_exists
)
from churnsim.utility import UtilityModel
from churnsim.customer import  Customer
...
if __name__ == "__main__":
    os.environ['CHURN_OUT_DIR'] = "alejandro"
